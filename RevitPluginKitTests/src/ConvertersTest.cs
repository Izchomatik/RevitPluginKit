namespace RevitPluginKitTests.Src
{
    ...
    /// <summary>
    /// Test value converters using: RevitPluginKit.Converters.
    /// </summary>
    [Transaction(TransactionMode.Manual)]
    [Regeneration(RegenerationOption.Manual)]
    internal class ConvertersTest : IExternalCommand
    {
            ...
            ElementSet elements)
        {
            ...
            List<TestResultData> testsResults = AddConvertersTest();
            ResultsViewer viewer = new ResultsViewer(
                title: "Converters tests",
        ...
        /// </returns>
        internal static List<TestResultData> AddConvertersTest()
        {
